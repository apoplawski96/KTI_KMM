...
/* KTI V2 */
val kti_primary = Color(0xFF2E2E2E)
val kti_dark_primary = Color(0xFFF5F5F0)
val kti_light_primary = Color(0xFF23313c)
val kti_text_icons = Color(0xFFF5F5F0)
val kti_accent_color = Color(0xFFD55951)
val kti_primary_text = Color(0xFF15191F)
val kti_secondary_text = Color(0xFF15191F)
val kti_divider = Color(0xFFBDBDBD)
val kti_green = Color(0xFF588A61)

val grey = Color(0xFFCFCFCF)
val dark_grey = Color(0xFF8D8D8D)