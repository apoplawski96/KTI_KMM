...
val kti_bright_red = Color(0xFFFF1F00)
val kti_green_variant = Color(0xFF71B77E)
val kti_yellow = Color(0xFFF2CD5D)
...
val kti_purple = Color(0xFF8086CE)
val kti_mauve = Color(0xFFCE95C1)
