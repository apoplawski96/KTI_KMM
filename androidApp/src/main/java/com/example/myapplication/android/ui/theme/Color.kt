...
val OffBlack = Color(0xFF292929)
val White = Color(0xFFFFFFFF)

val GoalRed = Color(0xFFF0705A)
val ErrorRed = Color(0xFFBC4042)
val BrightRed = Color(0xFFFF1F00)
val Green = Color(0xFF71B77E)
val Yellow = Color(0xFFF2CD5D)
val Blue = Color(0xFF6EA2DD)
val LightBlue = Color(0xFF74C3CE)
val DarkBlue = Color(0xFF003DC5)
val Orange = Color(0xFFF29A41)
val Purple = Color(0xFF8086CE)
val Mauve = Color(0xFFCE95C1)

val DarkGrey = Color(0xFF343434)
val Grey = Color(0xFF828282)
val MidGrey = Color(0xFFB6B7BB)
val LightGrey = Color(0xFFF6F6F6)

val Black60Alpha = Color(0x99000000)
val Black30Alpha = Color(0x4D000000)
